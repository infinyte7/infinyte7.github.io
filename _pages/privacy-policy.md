...
#### Google Analytics
The blog use [Google Analytics](https://analytics.google.com/analytics/web/). It is a web analytics service offered by Google that tracks and reports website traffic, currently as a platform inside the Google Marketing Platform brand.
View [Google Analytics privacy policy](https://policies.google.com/privacy?hl=en-US)
